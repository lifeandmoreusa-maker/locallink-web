...
const FloatingButton = ({ onOpenForm }) => {
  return (
    <div className="fixed right-4 bottom-6 md:right-8 md:bottom-10 z-40">
      ...
      >
        <div className="flex items-center justify-center w-[44px] md:w-[50px] h-[44px] md:h-[50px] bg-white rounded-full shadow-inner text-primary font-bold text-sm md:text-base group-hover:scale-110 transition-transform">
          J-US
        </div>
